...
export const LOGGING_PRISMA_SERVICE = 'LOGGING_PRISMA_SERVICE';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: LOGGING_PRISMA_SERVICE,
      inject: [REQUEST],
      scope: Scope.REQUEST,
      useFactory: (req: Request) => {
        // check 127.0.0.1 to support tests
        ...
        return MultiTenantMiddleware.loggingPrismas[host];
      },
    },
    {
  ...
  exports: [PRISMA_SERVICE, LOGGING_PRISMA_SERVICE, TENANT_CONFIG],
})
